...
class Utilisateur(db.Model):
    ...
    role = db.Column(db.Enum('admin', 'enseignant', 'secretaire'), nullable=False, default='secretaire')
...
class Presence(db.Model):
    ...
    statut = db.Column(db.Enum('PRESENT', 'ABSENT', 'RETARD', 'JUSTIFIE'), nullable=False)
